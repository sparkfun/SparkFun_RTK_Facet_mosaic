/*
  ...
  This sketch can be used to test mosaic COM3 (and COM2)
  * Connect an FTDI cable to the Connector Board Data Connector: TX->RX, RX->TX
  * Open a Serial Terminal at 115200 baud
  * Send SSSSSSSSSS escape sequence. Check COM3> is received in return
  * Repeat for the Radio Connector (COM2)
