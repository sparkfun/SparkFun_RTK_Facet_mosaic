/*
  ...
  This sketch can be used to test ESP32 'DAC' and 'ADC' pins through the multiplexer
  * Connect Data Connector TX to RX
  * Upload the sketch
  * Open a serial terminal at 115200 baud for the results
...
{
  Serial.print("DAC is ");
  Serial.print(digitalRead(muxDAC));
  Serial.print(". ADC is ");
  Serial.println(digitalRead(muxADC));

  delay(1000);
  digitalWrite(muxDAC, !digitalRead(muxADC));
}
